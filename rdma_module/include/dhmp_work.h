...
int amper_post_write(struct dhmp_task* task, struct ib_mr* rmr, uint64_t* sge_addr, uint32_t sge_length,uint32_t sge_lkey ,bool is_inline);
int amper_post_read(struct dhmp_task* task, struct ib_mr* rmr, uint64_t* sge_addr, uint32_t sge_length,uint32_t sge_lkey ,bool is_inline);
#endif
